...
enum
{
   ...
   ACTION_OK_DL_ROMM_SYNC_LIST,
   ACTION_OK_DL_ROMMARCH_CONFIG,
   ACTION_OK_DL_ROMM_LIBRARY,
   ACTION_OK_DL_ROMM_PLATFORM_ROMS,
   ACTION_OK_DL_ROMM_SAVE_SYNC,
   ACTION_OK_DL_ROMM_SAVE_DIRECTORIES,
   ACTION_OK_DL_ROMM_SAVE_PLATFORM,
