...
enum menu_displaylist_ctl_state
{
   ...
   DISPLAYLIST_ROMM_SYNC_LIST,
   DISPLAYLIST_ROMMARCH_CONFIG,
   DISPLAYLIST_ROMM_LIBRARY,
   DISPLAYLIST_ROMM_PLATFORM_ROMS,
   DISPLAYLIST_ROMM_SAVE_SYNC,
   DISPLAYLIST_ROMM_SAVE_DIRECTORIES,
   DISPLAYLIST_ROMM_SAVE_PLATFORM,
